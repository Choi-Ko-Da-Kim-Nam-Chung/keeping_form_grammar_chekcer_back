...
public class HwpParserImp implements HwpParser {
    ...
    @Override
    public void asyncParse(List<IBody> body, kr.dogfoot.hwplib.object.bodytext.paragraph.Paragraph[] paragraphs, SpellCheckerType spellCheckerType){
